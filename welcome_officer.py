...
bg = PhotoImage(file = "BG_welcome_office.png")
label1 = Label(root5, image=bg)
label1.place(x = 0, y = 0)

# Connect to Database
mydb = mysql.connect(host = "localhost", user = "root", password = "Pr@141003@", database = "realestate")
...
aid = Entry(root5, width = 29, fg = 'black', border = 0, bg = '#E5E5E5', font = ('Microsoft YaHei UI Light', 15))
aid.place(x = 267, y = 479)    

# submit button
button = Button(root5, text = 'SUBMIT', width = 18, command = signin , cursor = 'hand2', background= '#224957', foreground= 'white', activebackground = '#224957', activeforeground = 'black', font = ('yu gothic ui', 15, 'bold'), border = 0)
