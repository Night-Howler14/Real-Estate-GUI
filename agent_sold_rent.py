...
bg_br = PhotoImage(file = "BG_agent_sold.png") # BACKGROUND_AGENT_SOLD
...
buttonS = Button(root8, text = 'SUBMIT', width = 8, background= '#224957', foreground= 'white', activebackground = '#224957', activeforeground = 'black', font = ('yu gothic ui', 13, 'bold'), border = 0, command = topB).place(x = 920, y = 558)
